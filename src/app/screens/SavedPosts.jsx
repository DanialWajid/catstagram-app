  ...
  return (
    <View style={[styles.container, styles.containerDark]}>
      ...
      <View style={styles.viewModeContainer}>
        <TouchableOpacity
          style={[styles.viewModeButton, viewMode === 'grid' ? styles.selectedButtonDark : styles.unselectedButtonDark]}
          onPress={() => setViewMode('grid')}
        >
          <Grid size={16} color={viewMode === 'grid' ? '#ffffff' : '#a78bfa'} />
          <Text style={[styles.viewModeText, viewMode === 'grid' ? styles.selectedText : styles.unselectedTextDark]}>
            Grid
          </Text>
        </TouchableOpacity>
        
        <TouchableOpacity
          style={[styles.viewModeButton, viewMode === 'list' ? styles.selectedButtonDark : styles.unselectedButtonDark]}
          onPress={() => setViewMode('list')}
        >
          <List size={16} color={viewMode === 'list' ? '#ffffff' : '#a78bfa'} />
          <Text style={[styles.viewModeText, viewMode === 'list' ? styles.selectedText : styles.unselectedTextDark]}>
            List
          </Text>
        </TouchableOpacity>
      </View>
